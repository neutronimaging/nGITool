...
{
	size_t dims[3]={img.Size(2),img.Size(0),img.Size(1)};
...
void EstimatorBase::SaveHarmonicImages()
{
	if (m_bSaveHarmonicImages==true) {
		...
		kipl::io::WriteTIFF32(kipl::complexmath::imag(m_ReferenceH0),fname.str().c_str());
		fname.str("");
		fname<<m_sModuleName<<"_RefH0real.tif";
		kipl::io::WriteTIFF32(kipl::complexmath::real(m_ReferenceH0),fname.str().c_str());

		fname.str("");
		fname<<m_sModuleName<<"_RefH1imag.tif";
		kipl::io::WriteTIFF32(kipl::complexmath::imag(m_ReferenceH1),fname.str().c_str());
		fname.str("");
		fname<<m_sModuleName<<"_RefH1real.tif";
		kipl::io::WriteTIFF32(kipl::complexmath::real(m_ReferenceH1),fname.str().c_str());

		fname.str("");
		fname<<m_sModuleName<<"_SampleH0imag.tif";
		kipl::io::WriteTIFF32(kipl::complexmath::imag(m_SampleH0),fname.str().c_str());
		fname.str("");
		fname<<m_sModuleName<<"_SampleH0real.tif";
		kipl::io::WriteTIFF32(kipl::complexmath::real(m_SampleH0),fname.str().c_str());
		fname.str("");
		fname<<m_sModuleName<<"_SampleH1imag.tif";
		kipl::io::WriteTIFF32(kipl::complexmath::imag(m_SampleH1),fname.str().c_str());
		fname.str("");
		fname<<m_sModuleName<<"_SampleH1real.tif";
		kipl::io::WriteTIFF32(kipl::complexmath::real(m_SampleH1),fname.str().c_str());
	}
}
